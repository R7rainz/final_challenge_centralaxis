function BookDemoBanner() {
    return (
      <section className="container relative mx-auto flex flex-col items-center gap-10 px-6 pb-14">
        <article
          className="dark:bg-dark-surface-secondary relative flex flex-col items-center justify-center gap-9 self-stretch overflow-hidden rounded-xl border border-zinc-800 p-6"
          style={{ height: "250px" }}
        >
          <img
          ...
          <div className="relative z-20 flex flex-col items-center gap-2 text-center">
            <h4 className="text-3xl font-medium tracking-tighter text-white md:text-4xl">Book a Demo</h4>
            ...
            <div className="flex items-center gap-2">
              <a target="_blank" href="https://calendly.com/margarita-centralaxis/30min" rel="noreferrer">
