export default function Hero() {
  ...
  return (
    <section className="relative grid grid-cols-3 pb-16 items-center overflow-hidden">
      {/* Background Grid */}
      <div className="absolute left-0 top-0 z-[-2] bg-background-black-muted grid h-[90vh] w-full grid-cols-[clamp(28px,10vw,120px)_auto_clamp(28px,10vw,120px)] border-y border-zinc-800">
      ...
      {/* Hero Content */}
      <div className="relative flex-col divide-y divide-zinc-800 pt-[66px] col-span-3">
        ...
        <div>
          <div className="mx-auto flex min-h-[280px] sm:min-h-[360px] w-full max-w-[90vw] flex-col items-center justify-center gap-4 px-4 sm:px-6 md:px-16">
            <h1 className="text-center text-4xl sm:text-5xl md:text-7xl font-medium text-white sm:bg-gradient-to-r sm:from-gray-500 sm:via-white sm:to-gray-500 sm:bg-clip-text sm:text-transparent tracking-[1px] sm:tracking-[1.5px] md:tracking-[-2.5px] leading-tight mb-3">
              <span className="block sm:inline">Data Center</span>{" "}
              <span className="block sm:inline">Management Software</span>
            </h1>

            <h2 className="text-base sm:text-lg md:text-xl text-center text-gray-400 max-w-[320px] sm:max-w-lg md:max-w-3xl mx-auto">
